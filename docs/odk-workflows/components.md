...
1) Locate your odk yaml file and open it with your favourite text editor (src/ontology/mbao-odk.yaml)
...
```
  <uri name="https://purl.brain-bican.org/ontology/mbao/components/your-component-name.owl" uri="components/your-component-name.owl"/>
```

4) Add the component to the edit file (src/ontology/mbao-edit.obo)
for .obo formats: 

```
import: https://purl.brain-bican.org/ontology/mbao/components/your-component-name.owl
```
...
6) In your custom makefile (src/ontology/mbao.Makefile) add a goal for your custom make file. In this example, the goal is a ROBOT template.
