 ...
 * [mbao.yml](mbao.yml)
     * Determines how your purl.obolibrary.org/obo/mbao/ redirects will be handled
     ...
     * Paste in the contents of [mbao.yml](mbao.yml)
 ...
 * [mbao.md](mbao.md)
     ...
     * Paste in the contents of [mbao.md](mbao.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
